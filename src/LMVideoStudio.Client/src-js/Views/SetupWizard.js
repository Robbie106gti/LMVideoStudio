...
export function SetupWizard_view(model, dispatch) {
    ...
    return createElement("div", createObj(ofArray([["className", "fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-6"], (elems_5 = [createElement("div", createObj(ofArray([["className", "w-full max-w-lg rounded-xl border border-surface-border bg-surface-raised shadow-xl"], (elems_4 = [createElement("div", createObj(ofArray([["className", "px-6 py-4 border-b border-surface-border"], (elems = [createElement("h2", {
        ...
        return append((matchValue = model.Step, (matchValue.tag === 1) ? singleton(createElement("p", createObj(singleton_1((value_19 = "Click Continue to open Settings and run bootstrap. Sidecars start automatically in the Tauri desktop app.", ["children", value_19]))))) : ((matchValue.tag === 2) ? singleton(createElement("p", createObj(singleton_1((value_21 = "Setup marked complete. Import images on the timeline, generate thumbnail variants, and refresh your mockup preview.", ["children", value_21]))))) : singleton(createElement("p", createObj(singleton_1((value_17 = "This wizard runs bootstrap checks for Host, Ollama, Python worker, FFmpeg, and the model catalog. You can re-run bootstrap anytime from Settings.", ["children", value_17]))))))), delay(() => singleton(defaultArg(map((m) => createElement("p", {

...
import { StoryboardTimeline_view, StoryboardTimeline_withPreviewUrl, StoryboardTimeline_withPreviewStarted, StoryboardTimeline_withProjectAfterGenerate, StoryboardTimeline_withBakeUrl, StoryboardTimeline_withBakeStarted, StoryboardTimeline_withProject, StoryboardTimeline_withSharePack, StoryboardTimeline_withPreviewError, StoryboardTimeline_isUnusablePromptDraft, StoryboardTimeline_applyRecommendedBakeDuration, StoryboardTimeline_recommendedBakeDurationText, VariantModalMode, StoryboardTimeline_withBakeError, StoryboardTimeline_clearSharePack, StoryboardTimeline_updateSharePack, StoryboardTimeline_reorderByDrag, StoryboardTimeline_setDragIndex, StoryboardTimeline_moveDown, StoryboardTimeline_moveUp, StoryboardTimeline_init, StoryboardTimeline_selectBlock, TimelineMsg, TimelineModel, TimelineMsg_$reflection, TimelineModel_$reflection } from "./Views/StoryboardTimeline.js";
...
import { min, tryParse, max } from "./fable_modules/fable-library-js.4.27.0/Double.js";
...
import { tryParse as tryParse_1 } from "./fable_modules/fable-library-js.4.27.0/Guid.js";
    ...
    switch (msg.tag) {
        case 37: {
            ...
            if (matchValue_1.tag === 0) {
                ...
                if (shouldAutoSubmit(report.Severity, consent)) {
                    ...
                    })), encodeForSubmit(report), (Item) => (new AppMsg(38, [Item])))];
                }
                else {
                    return [model$0027, (msg_1 = (new AppMsg(39, [encodeForSubmit(report)])), singleton((dispatch) => {
                        dispatch(msg_1);
                    }))];
                }
            }
        ...
        case 35:
            if (msg.fields[0].tag === 1) {
                ...
                }, getSystemStatus, undefined, (Item_2) => (new AppMsg(17, [Item_2]))), singleton((dispatch_1) => {
                    dispatch_1(new AppMsg(40, [initialRoute]));
                })]))];
            }
        case 36:
            ...
            }, waitForHostHealth, undefined, (Item_3) => (new AppMsg(35, [Item_3])))];
        case 0:
            switch (msg.fields[0].tag) {
                ...
                case 0:
                    switch (msg.fields[0].fields[0].tag) {
                        ...
                        case 2: {
                            ...
                            }, getSystemStatus, undefined, (Item_12) => (new AppMsg(17, [Item_12]))), Cmd_OfAsyncWith_perform((x_15) => {
                                AsyncHelpers_start(x_15);
                            }, getModelStatus, undefined, (Item_13) => (new AppMsg(18, [Item_13]))), Cmd_OfAsyncWith_perform((x_16) => {
                                AsyncHelpers_start(x_16);
                            }, getConnectedAccounts, undefined, (Item_14) => (new AppMsg(27, [Item_14])))]))];
                        }
                        default: {
                ...
                default:
                    ...
                    }, () => singleton_1.Delay(() => singleton_1.Return(previewMediaUrl(t.Project.Id, "renders/bake/final.mp4", bust))), undefined, (Item_4) => (new AppMsg(15, [Item_4])))))) : ((((matchValue_5 === msg.fields[0].fields[0].JobId) && (msg.fields[0].fields[0].Phase === "bake")) && (msg.fields[0].fields[0].Status === "failed")) ? ((jobId_3 = matchValue_5, singleton((dispatch_2) => {
                        dispatch_2(new AppMsg(2, [new TimelineMsg(35, [msg.fields[0].fields[0].Message])]));
                    ...
                    })), undefined, (Item_5) => (new AppMsg(14, [Item_5])))))) : ((((matchValue_6 === msg.fields[0].fields[0].JobId) && (msg.fields[0].fields[0].Phase === "mockup_preview")) && (msg.fields[0].fields[0].Status === "failed")) ? ((jobId_7 = matchValue_6, singleton((dispatch_3) => {
                        dispatch_3(new AppMsg(2, [new TimelineMsg(34, [msg.fields[0].fields[0].Message])]));
            ...
            if (equals(routeFromModel(model), msg.fields[0])) {
                ...
                switch (msg.fields[0].tag) {
                    case 1: {
                        ...
                        }, getSystemStatus, undefined, (Item_8) => (new AppMsg(17, [Item_8]))), Cmd_OfAsyncWith_perform((x_9) => {
                            AsyncHelpers_start(x_9);
                        }, getModelStatus, undefined, (Item_9) => (new AppMsg(18, [Item_9]))), Cmd_OfAsyncWith_perform((x_10) => {
                            AsyncHelpers_start(x_10);
                        }, getConnectedAccounts, undefined, (Item_10) => (new AppMsg(27, [Item_10])))]))];
                    }
                    case 2: {
                        ...
                        switch (matchResult) {
                            ...
                            default:
                                ...
                                }, () => getProject(projectId), undefined, (r_1) => (new AppMsg(41, [Result_Map((p) => [p, blockId], r_1)])))];
                        }
                    }
                    default: {
        ...
        case 41:
            if (msg.fields[0].tag === 1) {
                ...
                return [new AppModel((bind$0040_12 = model.Shell, new ShellModel(new ShellTab(1, []), bind$0040_12.Activity, bind$0040_12.SystemStatus)), new AppPage(1, [StoryboardTimeline_selectBlock(StoryboardTimeline_init(msg.fields[0].fields[0][0]), msg.fields[0].fields[0][1])]), model.SetupWizard, msg.fields[0].fields[0][0].Id, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_12) => {
                    ...
                    if (_arg_4 == null) {
                        return new AppMsg(16, []);
                    }
                    else {
                        return new AppMsg(14, [_arg_4]);
                    }
                })];
            }
        case 4:
                ...
                case 6: {
                    ...
                    if (matchValue_17.tag === 0) {
                        ...
                        if (matchValue_18 != null) {
                            ...
                            }, () => generateOutline(projectId_1, hub_7.BriefText), undefined, (Item_17) => (new AppMsg(20, [Item_17])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                    ...
                    if (matchValue_21.tag === 0) {
                        ...
                        switch (matchResult_1) {
                            case 0:
                                ...
                                }, () => applyOutline(projectId_2, hub_10.BriefText, blocks_1), undefined, (Item_18) => (new AppMsg(21, [Item_18])))];
                            default:
                                return [model, Cmd_none()];
                        }
                    }
                ...
                case 9: {
                    ...
                    switch (matchResult_2) {
                        case 0:
                            ...
                            }, () => deleteProject(msg.fields[0].fields[0]), undefined, (Item_20) => (new AppMsg(32, [Item_20])))];
                        case 1:
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_5.Project, true, t_5.Generating, t_5.VideoGenerating, t_5.Previewing, t_5.Baking, t_5.PreviewUrl, t_5.BakeUrl, t_5.PreviewJobId, t_5.BakeJobId, undefined, t_5.DragIndex, t_5.SelectedBlockId, t_5.VoiceoverDraft, t_5.ImagePromptDraft, t_5.MoodTagsDraft, t_5.CrossfadeDurationDraft, t_5.DirectorNotesDraft, t_5.ShotKindDraft, t_5.BakeDurationDraft, t_5.ImagePromptQuickButtons, t_5.ReferenceStrengthDraft, t_5.MediaRevision, t_5.VariantModal, t_5.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_24) => {
                                AsyncHelpers_start(x_24);
                            }, () => deleteProject(msg.fields[0].fields[0]), undefined, (Item_21) => (new AppMsg(32, [Item_21])))];
                        default:
                            return [model, Cmd_none()];
                    }
                }
            ...
            if (msg.fields[0].tag === 1) {
                ...
                switch (matchValue_33.tag) {
                    ...
                    case 1: {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_7.Project, false, t_7.Generating, t_7.VideoGenerating, t_7.Previewing, t_7.Baking, t_7.PreviewUrl, t_7.BakeUrl, t_7.PreviewJobId, t_7.BakeJobId, msg.fields[0].fields[0], t_7.DragIndex, t_7.SelectedBlockId, t_7.VoiceoverDraft, t_7.ImagePromptDraft, t_7.MoodTagsDraft, t_7.CrossfadeDurationDraft, t_7.DirectorNotesDraft, t_7.ShotKindDraft, t_7.BakeDurationDraft, t_7.ImagePromptQuickButtons, t_7.ReferenceStrengthDraft, t_7.MediaRevision, t_7.VariantModal, t_7.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    default:
                        return [model, Cmd_none()];
                }
            ...
            switch (msg.fields[0].tag) {
                ...
                case 5: {
                    ...
                    if (matchValue_37.tag === 1) {
                        ...
                        if (matchValue_38 == null) {
                            ...
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(reordered.Project, true, reordered.Generating, reordered.VideoGenerating, reordered.Previewing, reordered.Baking, reordered.PreviewUrl, reordered.BakeUrl, reordered.PreviewJobId, reordered.BakeJobId, reordered.Error, reordered.DragIndex, reordered.SelectedBlockId, reordered.VoiceoverDraft, reordered.ImagePromptDraft, reordered.MoodTagsDraft, reordered.CrossfadeDurationDraft, reordered.DirectorNotesDraft, reordered.ShotKindDraft, reordered.BakeDurationDraft, reordered.ImagePromptQuickButtons, reordered.ReferenceStrengthDraft, reordered.MediaRevision, reordered.VariantModal, reordered.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_30) => {
                ...
                case 18: {
                    ...
                    if (matchValue_39.tag === 1) {
                        ...
                        if (matchValue_40 != null) {
                            ...
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_12.Project, true, t_12.Generating, t_12.VideoGenerating, t_12.Previewing, t_12.Baking, t_12.PreviewUrl, t_12.BakeUrl, t_12.PreviewJobId, t_12.BakeJobId, t_12.Error, t_12.DragIndex, t_12.SelectedBlockId, t_12.VoiceoverDraft, t_12.ImagePromptDraft, t_12.MoodTagsDraft, t_12.CrossfadeDurationDraft, t_12.DirectorNotesDraft, t_12.ShotKindDraft, t_12.BakeDurationDraft, t_12.ImagePromptQuickButtons, t_12.ReferenceStrengthDraft, t_12.MediaRevision, t_12.VariantModal, t_12.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_31) => {
                                AsyncHelpers_start(x_31);
                            }, () => selectBlockThumbnail(t_12.Project.Id, blockId_2, msg.fields[0].fields[0]), undefined, (Item_27) => (new AppMsg(30, [Item_27])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 32: {
                    ...
                    if (matchValue_41.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_13.Project, true, t_13.Generating, t_13.VideoGenerating, t_13.Previewing, t_13.Baking, t_13.PreviewUrl, t_13.BakeUrl, t_13.PreviewJobId, t_13.BakeJobId, t_13.Error, t_13.DragIndex, t_13.SelectedBlockId, t_13.VoiceoverDraft, t_13.ImagePromptDraft, t_13.MoodTagsDraft, t_13.CrossfadeDurationDraft, t_13.DirectorNotesDraft, t_13.ShotKindDraft, t_13.BakeDurationDraft, t_13.ImagePromptQuickButtons, t_13.ReferenceStrengthDraft, t_13.MediaRevision, t_13.VariantModal, t_13.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_batch(ofArray([Cmd_OfAsyncWith_perform((x_32) => {
                            AsyncHelpers_start(x_32);
                        }, getConnectedAccounts, undefined, (Item_28) => (new AppMsg(25, [Item_28]))), Cmd_OfAsyncWith_perform((x_33) => {
                            AsyncHelpers_start(x_33);
                        }, () => exportSharePackDetailed(t_13.Project.Id), undefined, (Item_29) => (new AppMsg(24, [Item_29])))]))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                    ...
                    switch (msg.fields[0].fields[0].tag) {
                            ...
                            if (matchValue_47.tag === 1) {
                                ...
                                if (matchValue_48 != null) {
                                    ...
                                    if (matchValue_49.tag === 1) {
                                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_18.Project, t_18.Saving, t_18.Generating, t_18.VideoGenerating, t_18.Previewing, t_18.Baking, t_18.PreviewUrl, t_18.BakeUrl, t_18.PreviewJobId, t_18.BakeJobId, matchValue_49.fields[0], t_18.DragIndex, t_18.SelectedBlockId, t_18.VoiceoverDraft, t_18.ImagePromptDraft, t_18.MoodTagsDraft, t_18.CrossfadeDurationDraft, t_18.DirectorNotesDraft, t_18.ShotKindDraft, t_18.BakeDurationDraft, t_18.ImagePromptQuickButtons, t_18.ReferenceStrengthDraft, t_18.MediaRevision, t_18.VariantModal, t_18.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                                    }
                                    else {
                        ...
                        case 3: {
                            ...
                            if (matchValue_50.tag === 1) {
                                ...
                                }, () => uploadSharePack(t_19.Project.Id, "youtube", t_19.Project.Name, map((sp_4) => sp_4.CaptionText, t_19.SharePack)), undefined, (Item_30) => (new AppMsg(26, [Item_30])))];
                            }
                            else {
                                return [model, Cmd_none()];
                            }
                        ...
                        case 4: {
                            ...
                            if (matchValue_51.tag === 1) {
                                ...
                                }, () => uploadSharePack(t_20.Project.Id, "meta", t_20.Project.Name, map((sp_6) => sp_6.CaptionText, t_20.SharePack)), undefined, (Item_31) => (new AppMsg(26, [Item_31])))];
                            }
                            else {
                                return [model, Cmd_none()];
                            }
                ...
                case 36: {
                    ...
                    if (matchValue_57.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_25.Project, true, t_25.Generating, t_25.VideoGenerating, t_25.Previewing, t_25.Baking, t_25.PreviewUrl, t_25.BakeUrl, t_25.PreviewJobId, t_25.BakeJobId, t_25.Error, t_25.DragIndex, t_25.SelectedBlockId, t_25.VoiceoverDraft, t_25.ImagePromptDraft, t_25.MoodTagsDraft, t_25.CrossfadeDurationDraft, t_25.DirectorNotesDraft, t_25.ShotKindDraft, t_25.BakeDurationDraft, t_25.ImagePromptQuickButtons, t_25.ReferenceStrengthDraft, t_25.MediaRevision, t_25.VariantModal, t_25.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_37) => {
                ...
                case 1: {
                    ...
                    if (matchValue_60.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_27.Project, true, t_27.Generating, t_27.VideoGenerating, t_27.Previewing, t_27.Baking, t_27.PreviewUrl, t_27.BakeUrl, t_27.PreviewJobId, t_27.BakeJobId, t_27.Error, t_27.DragIndex, t_27.SelectedBlockId, t_27.VoiceoverDraft, t_27.ImagePromptDraft, t_27.MoodTagsDraft, t_27.CrossfadeDurationDraft, t_27.DirectorNotesDraft, t_27.ShotKindDraft, t_27.BakeDurationDraft, t_27.ImagePromptQuickButtons, t_27.ReferenceStrengthDraft, t_27.MediaRevision, t_27.VariantModal, t_27.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_38) => {
                            AsyncHelpers_start(x_38);
                        }, () => importStylePackLogo(t_27.Project.Id, msg.fields[0].fields[0]), undefined, (Item_33) => (new AppMsg(22, [Item_33])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 31: {
                    ...
                    if (matchValue_63.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_30.Project, t_30.Saving, t_30.Generating, t_30.VideoGenerating, t_30.Previewing, true, t_30.PreviewUrl, t_30.BakeUrl, t_30.PreviewJobId, t_30.BakeJobId, undefined, t_30.DragIndex, t_30.SelectedBlockId, t_30.VoiceoverDraft, t_30.ImagePromptDraft, t_30.MoodTagsDraft, t_30.CrossfadeDurationDraft, t_30.DirectorNotesDraft, t_30.ShotKindDraft, t_30.BakeDurationDraft, t_30.ImagePromptQuickButtons, t_30.ReferenceStrengthDraft, t_30.MediaRevision, t_30.VariantModal, t_30.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_39) => {
                            AsyncHelpers_start(x_39);
                        }, () => startBake(t_30.Project.Id), undefined, (Item_34) => (new AppMsg(23, [Item_34])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 19: {
                    ...
                    if (matchValue_73.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_40.Project, t_40.Saving, t_40.Generating, t_40.VideoGenerating, t_40.Previewing, t_40.Baking, t_40.PreviewUrl, t_40.BakeUrl, t_40.PreviewJobId, t_40.BakeJobId, t_40.Error, t_40.DragIndex, t_40.SelectedBlockId, t_40.VoiceoverDraft, t_40.ImagePromptDraft, t_40.MoodTagsDraft, t_40.CrossfadeDurationDraft, t_40.DirectorNotesDraft, t_40.ShotKindDraft, t_40.BakeDurationDraft, t_40.ImagePromptQuickButtons, t_40.ReferenceStrengthDraft, t_40.MediaRevision, new VariantModalMode(0, []), t_40.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 20: {
                    ...
                    if (matchValue_74.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_41.Project, t_41.Saving, t_41.Generating, t_41.VideoGenerating, t_41.Previewing, t_41.Baking, t_41.PreviewUrl, t_41.BakeUrl, t_41.PreviewJobId, t_41.BakeJobId, t_41.Error, t_41.DragIndex, t_41.SelectedBlockId, t_41.VoiceoverDraft, t_41.ImagePromptDraft, t_41.MoodTagsDraft, t_41.CrossfadeDurationDraft, t_41.DirectorNotesDraft, t_41.ShotKindDraft, t_41.BakeDurationDraft, t_41.ImagePromptQuickButtons, t_41.ReferenceStrengthDraft, t_41.MediaRevision, undefined, t_41.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 21: {
                    ...
                    if (matchValue_75.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_42.Project, t_42.Saving, t_42.Generating, t_42.VideoGenerating, t_42.Previewing, t_42.Baking, t_42.PreviewUrl, t_42.BakeUrl, t_42.PreviewJobId, t_42.BakeJobId, t_42.Error, t_42.DragIndex, t_42.SelectedBlockId, t_42.VoiceoverDraft, t_42.ImagePromptDraft, t_42.MoodTagsDraft, t_42.CrossfadeDurationDraft, t_42.DirectorNotesDraft, t_42.ShotKindDraft, t_42.BakeDurationDraft, t_42.ImagePromptQuickButtons, t_42.ReferenceStrengthDraft, t_42.MediaRevision, new VariantModalMode(1, [msg.fields[0].fields[0]]), t_42.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 22: {
                    ...
                    if (matchValue_76.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_43.Project, t_43.Saving, t_43.Generating, t_43.VideoGenerating, t_43.Previewing, t_43.Baking, t_43.PreviewUrl, t_43.BakeUrl, t_43.PreviewJobId, t_43.BakeJobId, t_43.Error, t_43.DragIndex, t_43.SelectedBlockId, t_43.VoiceoverDraft, t_43.ImagePromptDraft, t_43.MoodTagsDraft, t_43.CrossfadeDurationDraft, t_43.DirectorNotesDraft, t_43.ShotKindDraft, t_43.BakeDurationDraft, t_43.ImagePromptQuickButtons, t_43.ReferenceStrengthDraft, t_43.MediaRevision, new VariantModalMode(0, []), t_43.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 23: {
                    ...
                    if (matchValue_77.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_44.Project, t_44.Saving, t_44.Generating, t_44.VideoGenerating, t_44.Previewing, t_44.Baking, t_44.PreviewUrl, t_44.BakeUrl, t_44.PreviewJobId, t_44.BakeJobId, t_44.Error, t_44.DragIndex, t_44.SelectedBlockId, t_44.VoiceoverDraft, msg.fields[0].fields[0], t_44.MoodTagsDraft, t_44.CrossfadeDurationDraft, t_44.DirectorNotesDraft, t_44.ShotKindDraft, t_44.BakeDurationDraft, t_44.ImagePromptQuickButtons, t_44.ReferenceStrengthDraft, t_44.MediaRevision, t_44.VariantModal, t_44.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 24: {
                    ...
                    if (matchValue_78.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_45.Project, t_45.Saving, t_45.Generating, t_45.VideoGenerating, t_45.Previewing, t_45.Baking, t_45.PreviewUrl, t_45.BakeUrl, t_45.PreviewJobId, t_45.BakeJobId, t_45.Error, t_45.DragIndex, t_45.SelectedBlockId, t_45.VoiceoverDraft, t_45.ImagePromptDraft, t_45.MoodTagsDraft, t_45.CrossfadeDurationDraft, t_45.DirectorNotesDraft, t_45.ShotKindDraft, t_45.BakeDurationDraft, loadAll(), t_45.ReferenceStrengthDraft, t_45.MediaRevision, t_45.VariantModal, t_45.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 7: {
                    ...
                    if (matchValue_79.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_46.Project, t_46.Saving, t_46.Generating, t_46.VideoGenerating, t_46.Previewing, t_46.Baking, t_46.PreviewUrl, t_46.BakeUrl, t_46.PreviewJobId, t_46.BakeJobId, t_46.Error, t_46.DragIndex, t_46.SelectedBlockId, msg.fields[0].fields[0], t_46.ImagePromptDraft, t_46.MoodTagsDraft, t_46.CrossfadeDurationDraft, t_46.DirectorNotesDraft, t_46.ShotKindDraft, t_46.BakeDurationDraft, t_46.ImagePromptQuickButtons, t_46.ReferenceStrengthDraft, t_46.MediaRevision, t_46.VariantModal, t_46.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 8: {
                    ...
                    if (matchValue_80.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_47.Project, t_47.Saving, t_47.Generating, t_47.VideoGenerating, t_47.Previewing, t_47.Baking, t_47.PreviewUrl, t_47.BakeUrl, t_47.PreviewJobId, t_47.BakeJobId, t_47.Error, t_47.DragIndex, t_47.SelectedBlockId, t_47.VoiceoverDraft, msg.fields[0].fields[0], t_47.MoodTagsDraft, t_47.CrossfadeDurationDraft, t_47.DirectorNotesDraft, t_47.ShotKindDraft, t_47.BakeDurationDraft, t_47.ImagePromptQuickButtons, t_47.ReferenceStrengthDraft, t_47.MediaRevision, t_47.VariantModal, t_47.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 9: {
                    ...
                    if (matchValue_81.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_48.Project, t_48.Saving, t_48.Generating, t_48.VideoGenerating, t_48.Previewing, t_48.Baking, t_48.PreviewUrl, t_48.BakeUrl, t_48.PreviewJobId, t_48.BakeJobId, t_48.Error, t_48.DragIndex, t_48.SelectedBlockId, t_48.VoiceoverDraft, t_48.ImagePromptDraft, msg.fields[0].fields[0], t_48.CrossfadeDurationDraft, t_48.DirectorNotesDraft, t_48.ShotKindDraft, t_48.BakeDurationDraft, t_48.ImagePromptQuickButtons, t_48.ReferenceStrengthDraft, t_48.MediaRevision, t_48.VariantModal, t_48.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 10: {
                    ...
                    if (matchValue_82.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_49.Project, t_49.Saving, t_49.Generating, t_49.VideoGenerating, t_49.Previewing, t_49.Baking, t_49.PreviewUrl, t_49.BakeUrl, t_49.PreviewJobId, t_49.BakeJobId, t_49.Error, t_49.DragIndex, t_49.SelectedBlockId, t_49.VoiceoverDraft, t_49.ImagePromptDraft, t_49.MoodTagsDraft, max(0, msg.fields[0].fields[0]), t_49.DirectorNotesDraft, t_49.ShotKindDraft, t_49.BakeDurationDraft, t_49.ImagePromptQuickButtons, t_49.ReferenceStrengthDraft, t_49.MediaRevision, t_49.VariantModal, t_49.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 11: {
                    ...
                    if (matchValue_83.tag === 1) {
                        ...
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_50.Project, t_50.Saving, t_50.Generating, t_50.VideoGenerating, t_50.Previewing, t_50.Baking, t_50.PreviewUrl, t_50.BakeUrl, t_50.PreviewJobId, t_50.BakeJobId, t_50.Error, t_50.DragIndex, t_50.SelectedBlockId, t_50.VoiceoverDraft, t_50.ImagePromptDraft, t_50.MoodTagsDraft, t_50.CrossfadeDurationDraft, msg.fields[0].fields[0], t_50.ShotKindDraft, t_50.BakeDurationDraft, t_50.ImagePromptQuickButtons, t_50.ReferenceStrengthDraft, t_50.MediaRevision, t_50.VariantModal, t_50.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 12: {
                    ...
                    if (matchValue_84.tag === 1) {
                        const t_51 = matchValue_84.fields[0];
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_51.Project, t_51.Saving, t_51.Generating, t_51.VideoGenerating, t_51.Previewing, t_51.Baking, t_51.PreviewUrl, t_51.BakeUrl, t_51.PreviewJobId, t_51.BakeJobId, t_51.Error, t_51.DragIndex, t_51.SelectedBlockId, t_51.VoiceoverDraft, t_51.ImagePromptDraft, t_51.MoodTagsDraft, t_51.CrossfadeDurationDraft, t_51.DirectorNotesDraft, msg.fields[0].fields[0], (msg.fields[0].fields[0] == null) ? t_51.BakeDurationDraft : StoryboardTimeline_recommendedBakeDurationText(msg.fields[0].fields[0]), t_51.ImagePromptQuickButtons, t_51.ReferenceStrengthDraft, t_51.MediaRevision, t_51.VariantModal, t_51.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 13: {
                    ...
                    if (matchValue_85.tag === 1) {
                        const t_52 = matchValue_85.fields[0];
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_52.Project, t_52.Saving, t_52.Generating, t_52.VideoGenerating, t_52.Previewing, t_52.Baking, t_52.PreviewUrl, t_52.BakeUrl, t_52.PreviewJobId, t_52.BakeJobId, t_52.Error, t_52.DragIndex, t_52.SelectedBlockId, t_52.VoiceoverDraft, t_52.ImagePromptDraft, t_52.MoodTagsDraft, t_52.CrossfadeDurationDraft, t_52.DirectorNotesDraft, t_52.ShotKindDraft, msg.fields[0].fields[0], t_52.ImagePromptQuickButtons, t_52.ReferenceStrengthDraft, t_52.MediaRevision, t_52.VariantModal, t_52.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 14: {
                    ...
                    if (matchValue_86.tag === 1) {
                        return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_applyRecommendedBakeDuration(matchValue_86.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 15: {
                    ...
                    if (matchValue_87.tag === 1) {
                        const t_54 = matchValue_87.fields[0];
                        const matchValue_88 = t_54.SelectedBlockId;
                        if (matchValue_88 != null) {
                            const blockId_3 = matchValue_88;
                            const prompt_1 = isNullOrWhiteSpace(t_54.ImagePromptDraft) ? undefined : t_54.ImagePromptDraft;
                            let moodTags;
                            const tags = ofArray((array_1 = map_2((s_5) => s_5.trim(), split(t_54.MoodTagsDraft, [","], undefined, 0)), array_1.filter((s_6) => !isNullOrWhiteSpace(s_6))));
                            moodTags = (isEmpty(tags) ? undefined : tags);
                            const directorNotes = isNullOrWhiteSpace(t_54.DirectorNotesDraft) ? undefined : t_54.DirectorNotesDraft;
                            let bakeSave;
                            if (isNullOrWhiteSpace(t_54.BakeDurationDraft)) {
                                bakeSave = (new FSharpResult$2(0, [[true, undefined]]));
                            }
                            else {
                                let matchValue_89;
                                let outArg_1 = 0;
                                matchValue_89 = [tryParse(t_54.BakeDurationDraft, new FSharpRef(() => outArg_1, (v_1) => {
                                    outArg_1 = v_1;
                                })), outArg_1];
                                bakeSave = (matchValue_89[0] ? (((sec = matchValue_89[1], (sec >= ProjectModule_bakeDurationMinSec) && (sec <= ProjectModule_bakeDurationMaxSec))) ? (new FSharpResult$2(0, [[false, matchValue_89[1]]])) : (new FSharpResult$2(1, [`Bake length must be between ${ProjectModule_bakeDurationMinSec} and ${ProjectModule_bakeDurationMaxSec} seconds.`]))) : (new FSharpResult$2(1, ["Bake clip length must be a number."])));
                            }
                            if (bakeSave.tag === 0) {
                                return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_54.Project, true, t_54.Generating, t_54.VideoGenerating, t_54.Previewing, t_54.Baking, t_54.PreviewUrl, t_54.BakeUrl, t_54.PreviewJobId, t_54.BakeJobId, undefined, t_54.DragIndex, t_54.SelectedBlockId, t_54.VoiceoverDraft, t_54.ImagePromptDraft, t_54.MoodTagsDraft, t_54.CrossfadeDurationDraft, t_54.DirectorNotesDraft, t_54.ShotKindDraft, t_54.BakeDurationDraft, t_54.ImagePromptQuickButtons, t_54.ReferenceStrengthDraft, t_54.MediaRevision, t_54.VariantModal, t_54.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_43) => {
                                    AsyncHelpers_start(x_43);
                                }, () => updateBlock(t_54.Project.Id, blockId_3, t_54.VoiceoverDraft, prompt_1, t_54.CrossfadeDurationDraft, moodTags, directorNotes, t_54.ShotKindDraft, bakeSave.fields[0][1], bakeSave.fields[0][0]), undefined, (Item_37) => (new AppMsg(9, [Item_37])))];
                            }
                            else {
                                return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_54.Project, t_54.Saving, t_54.Generating, t_54.VideoGenerating, t_54.Previewing, t_54.Baking, t_54.PreviewUrl, t_54.BakeUrl, t_54.PreviewJobId, t_54.BakeJobId, bakeSave.fields[0], t_54.DragIndex, t_54.SelectedBlockId, t_54.VoiceoverDraft, t_54.ImagePromptDraft, t_54.MoodTagsDraft, t_54.CrossfadeDurationDraft, t_54.DirectorNotesDraft, t_54.ShotKindDraft, t_54.BakeDurationDraft, t_54.ImagePromptQuickButtons, t_54.ReferenceStrengthDraft, t_54.MediaRevision, t_54.VariantModal, t_54.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                            }
                        }
                        else {
                            return [model, Cmd_none()];
                ...
                case 16: {
                    ...
                    if (matchValue_92.tag === 1) {
                        const t_57 = matchValue_92.fields[0];
                        const matchValue_93 = t_57.SelectedBlockId;
                        if (matchValue_93 != null) {
                            const blockId_4 = matchValue_93;
                            const block_2 = tryFind((b_5) => (b_5.Id === blockId_4), t_57.Project.Blocks);
                            ...
                            const prompt_2 = StoryboardTimeline_isUnusablePromptDraft(t_57.ImagePromptDraft) ? undefined : (isNullOrWhiteSpace(t_57.ImagePromptDraft) ? undefined : t_57.ImagePromptDraft);
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_57.Project, t_57.Saving, true, t_57.VideoGenerating, t_57.Previewing, t_57.Baking, t_57.PreviewUrl, t_57.BakeUrl, t_57.PreviewJobId, t_57.BakeJobId, undefined, t_57.DragIndex, t_57.SelectedBlockId, t_57.VoiceoverDraft, t_57.ImagePromptDraft, t_57.MoodTagsDraft, t_57.CrossfadeDurationDraft, t_57.DirectorNotesDraft, t_57.ShotKindDraft, t_57.BakeDurationDraft, t_57.ImagePromptQuickButtons, t_57.ReferenceStrengthDraft, t_57.MediaRevision, t_57.VariantModal, t_57.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_44) => {
                                AsyncHelpers_start(x_44);
                            }, () => generateBlockThumbnail(t_57.Project.Id, blockId_4, prompt_2, 3, t_57.ReferenceStrengthDraft, useThumbnail), undefined, (Item_38) => (new AppMsg(10, [Item_38])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 17: {
                    ...
                    if (matchValue_94.tag === 1) {
                        const t_58 = matchValue_94.fields[0];
                        const matchValue_95 = t_58.SelectedBlockId;
                        if (matchValue_95 != null) {
                            const blockId_5 = matchValue_95;
                            const prompt_3 = (StoryboardTimeline_isUnusablePromptDraft(t_58.ImagePromptDraft) ? true : isNullOrWhiteSpace(t_58.ImagePromptDraft)) ? undefined : t_58.ImagePromptDraft;
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_58.Project, t_58.Saving, t_58.Generating, true, t_58.Previewing, t_58.Baking, t_58.PreviewUrl, t_58.BakeUrl, t_58.PreviewJobId, t_58.BakeJobId, undefined, t_58.DragIndex, t_58.SelectedBlockId, t_58.VoiceoverDraft, t_58.ImagePromptDraft, t_58.MoodTagsDraft, t_58.CrossfadeDurationDraft, t_58.DirectorNotesDraft, t_58.ShotKindDraft, t_58.BakeDurationDraft, t_58.ImagePromptQuickButtons, t_58.ReferenceStrengthDraft, t_58.MediaRevision, t_58.VariantModal, t_58.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_45) => {
                                AsyncHelpers_start(x_45);
                            }, () => generateBlockVideo(t_58.Project.Id, blockId_5, prompt_3), undefined, (Item_39) => (new AppMsg(11, [Item_39])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 25: {
                    ...
                    if (matchValue_96.tag === 1) {
                        const t_59 = matchValue_96.fields[0];
                        const matchValue_97 = t_59.SelectedBlockId;
                        if (matchValue_97 != null) {
                            const blockId_6 = matchValue_97;
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_59.Project, true, t_59.Generating, t_59.VideoGenerating, t_59.Previewing, t_59.Baking, t_59.PreviewUrl, t_59.BakeUrl, t_59.PreviewJobId, t_59.BakeJobId, t_59.Error, t_59.DragIndex, t_59.SelectedBlockId, t_59.VoiceoverDraft, t_59.ImagePromptDraft, t_59.MoodTagsDraft, t_59.CrossfadeDurationDraft, t_59.DirectorNotesDraft, t_59.ShotKindDraft, t_59.BakeDurationDraft, t_59.ImagePromptQuickButtons, t_59.ReferenceStrengthDraft, t_59.MediaRevision, t_59.VariantModal, t_59.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_46) => {
                                AsyncHelpers_start(x_46);
                            }, () => importBlockReferenceImage(t_59.Project.Id, blockId_6, msg.fields[0].fields[0]), undefined, (Item_40) => (new AppMsg(31, [Item_40])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 26: {
                    ...
                    if (matchValue_98.tag === 1) {
                        const t_60 = matchValue_98.fields[0];
                        const matchValue_99 = t_60.SelectedBlockId;
                        if (matchValue_99 != null) {
                            const blockId_7 = matchValue_99;
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_60.Project, true, t_60.Generating, t_60.VideoGenerating, t_60.Previewing, t_60.Baking, t_60.PreviewUrl, t_60.BakeUrl, t_60.PreviewJobId, t_60.BakeJobId, t_60.Error, t_60.DragIndex, t_60.SelectedBlockId, t_60.VoiceoverDraft, t_60.ImagePromptDraft, t_60.MoodTagsDraft, t_60.CrossfadeDurationDraft, t_60.DirectorNotesDraft, t_60.ShotKindDraft, t_60.BakeDurationDraft, t_60.ImagePromptQuickButtons, t_60.ReferenceStrengthDraft, t_60.MediaRevision, t_60.VariantModal, t_60.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_47) => {
                                AsyncHelpers_start(x_47);
                            }, () => clearBlockReferenceImage(t_60.Project.Id, blockId_7), undefined, (Item_41) => (new AppMsg(31, [Item_41])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 27: {
                    ...
                    if (matchValue_100.tag === 1) {
                        const t_61 = matchValue_100.fields[0];
                        const matchValue_101 = t_61.SelectedBlockId;
                        if (matchValue_101 != null) {
                            const blockId_8 = matchValue_101;
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_61.Project, true, t_61.Generating, t_61.VideoGenerating, t_61.Previewing, t_61.Baking, t_61.PreviewUrl, t_61.BakeUrl, t_61.PreviewJobId, t_61.BakeJobId, t_61.Error, t_61.DragIndex, t_61.SelectedBlockId, t_61.VoiceoverDraft, t_61.ImagePromptDraft, t_61.MoodTagsDraft, t_61.CrossfadeDurationDraft, t_61.DirectorNotesDraft, t_61.ShotKindDraft, t_61.BakeDurationDraft, t_61.ImagePromptQuickButtons, t_61.ReferenceStrengthDraft, t_61.MediaRevision, t_61.VariantModal, t_61.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_48) => {
                                AsyncHelpers_start(x_48);
                            }, () => useBlockThumbnailAsReference(t_61.Project.Id, blockId_8), undefined, (Item_42) => (new AppMsg(31, [Item_42])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 28: {
                    ...
                    if (matchValue_102.tag === 1) {
                        const t_62 = matchValue_102.fields[0];
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_62.Project, t_62.Saving, t_62.Generating, t_62.VideoGenerating, t_62.Previewing, t_62.Baking, t_62.PreviewUrl, t_62.BakeUrl, t_62.PreviewJobId, t_62.BakeJobId, t_62.Error, t_62.DragIndex, t_62.SelectedBlockId, t_62.VoiceoverDraft, t_62.ImagePromptDraft, t_62.MoodTagsDraft, t_62.CrossfadeDurationDraft, t_62.DirectorNotesDraft, t_62.ShotKindDraft, t_62.BakeDurationDraft, t_62.ImagePromptQuickButtons, max(0.15, min(0.65, msg.fields[0].fields[0])), t_62.MediaRevision, t_62.VariantModal, t_62.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 29: {
                    ...
                    if (matchValue_109.tag === 1) {
                        const t_69 = matchValue_109.fields[0];
                        const matchValue_110 = t_69.SelectedBlockId;
                        if (matchValue_110 != null) {
                            const blockId_9 = matchValue_110;
                            return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_69.Project, true, t_69.Generating, t_69.VideoGenerating, t_69.Previewing, t_69.Baking, t_69.PreviewUrl, t_69.BakeUrl, t_69.PreviewJobId, t_69.BakeJobId, t_69.Error, t_69.DragIndex, t_69.SelectedBlockId, t_69.VoiceoverDraft, t_69.ImagePromptDraft, t_69.MoodTagsDraft, t_69.CrossfadeDurationDraft, t_69.DirectorNotesDraft, t_69.ShotKindDraft, t_69.BakeDurationDraft, t_69.ImagePromptQuickButtons, t_69.ReferenceStrengthDraft, t_69.MediaRevision, t_69.VariantModal, t_69.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_49) => {
                                AsyncHelpers_start(x_49);
                            }, () => importBlockAudio(t_69.Project.Id, blockId_9, msg.fields[0].fields[0]), undefined, (Item_43) => (new AppMsg(12, [Item_43])))];
                        }
                        else {
                            return [model, Cmd_none()];
                        }
                ...
                case 30: {
                    ...
                    if (matchValue_113.tag === 1) {
                        const t_72 = matchValue_113.fields[0];
                        return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_72.Project, t_72.Saving, t_72.Generating, t_72.VideoGenerating, true, t_72.Baking, t_72.PreviewUrl, t_72.BakeUrl, t_72.PreviewJobId, t_72.BakeJobId, undefined, t_72.DragIndex, t_72.SelectedBlockId, t_72.VoiceoverDraft, t_72.ImagePromptDraft, t_72.MoodTagsDraft, t_72.CrossfadeDurationDraft, t_72.DirectorNotesDraft, t_72.ShotKindDraft, t_72.BakeDurationDraft, t_72.ImagePromptQuickButtons, t_72.ReferenceStrengthDraft, t_72.MediaRevision, t_72.VariantModal, t_72.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_50) => {
                            AsyncHelpers_start(x_50);
                        }, () => refreshMockupPreview(t_72.Project.Id), undefined, (Item_44) => (new AppMsg(13, [Item_44])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 34: {
                    ...
                    if (matchValue_117.tag === 1) {
                        return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withPreviewError(msg.fields[0].fields[0], matchValue_117.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
        ...
        case 26:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_54.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [(t$0027 = StoryboardTimeline_updateSharePack((sp_8) => (new SharePackModel(sp_8.OutputDir, sp_8.Files, sp_8.CaptionPath, sp_8.CaptionText, sp_8.ReadmePath, sp_8.MediaBase, undefined, sp_8.UploadMessage, sp_8.ConnectedAccounts)), matchValue_54.fields[0]), new TimelineModel(t$0027.Project, t$0027.Saving, t$0027.Generating, t$0027.VideoGenerating, t$0027.Previewing, t$0027.Baking, t$0027.PreviewUrl, t$0027.BakeUrl, t$0027.PreviewJobId, t$0027.BakeJobId, msg.fields[0].fields[0], t$0027.DragIndex, t$0027.SelectedBlockId, t$0027.VoiceoverDraft, t$0027.ImagePromptDraft, t$0027.MoodTagsDraft, t$0027.CrossfadeDurationDraft, t$0027.DirectorNotesDraft, t$0027.ShotKindDraft, t$0027.BakeDurationDraft, t$0027.ImagePromptQuickButtons, t$0027.ReferenceStrengthDraft, t$0027.MediaRevision, t$0027.VariantModal, t$0027.SharePack))]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 30:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_56.tag === 1) {
                    ...
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_24.Project, false, t_24.Generating, t_24.VideoGenerating, t_24.Previewing, t_24.Baking, t_24.PreviewUrl, t_24.BakeUrl, t_24.PreviewJobId, t_24.BakeJobId, msg.fields[0].fields[0], t_24.DragIndex, t_24.SelectedBlockId, t_24.VoiceoverDraft, t_24.ImagePromptDraft, t_24.MoodTagsDraft, t_24.CrossfadeDurationDraft, t_24.DirectorNotesDraft, t_24.ShotKindDraft, t_24.BakeDurationDraft, t_24.ImagePromptQuickButtons, t_24.ReferenceStrengthDraft, t_24.MediaRevision, t_24.VariantModal, t_24.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 7:
            if (msg.fields[0].tag === 1) {
                ...
                return [new AppModel(model.Shell, new AppPage(1, [(bind$0040_23 = StoryboardTimeline_init(msg.fields[0].fields[0]), new TimelineModel(bind$0040_23.Project, false, bind$0040_23.Generating, bind$0040_23.VideoGenerating, bind$0040_23.Previewing, bind$0040_23.Baking, bind$0040_23.PreviewUrl, bind$0040_23.BakeUrl, bind$0040_23.PreviewJobId, bind$0040_23.BakeJobId, undefined, bind$0040_23.DragIndex, bind$0040_23.SelectedBlockId, bind$0040_23.VoiceoverDraft, bind$0040_23.ImagePromptDraft, bind$0040_23.MoodTagsDraft, bind$0040_23.CrossfadeDurationDraft, bind$0040_23.DirectorNotesDraft, bind$0040_23.ShotKindDraft, bind$0040_23.BakeDurationDraft, bind$0040_23.ImagePromptQuickButtons, bind$0040_23.ReferenceStrengthDraft, bind$0040_23.MediaRevision, bind$0040_23.VariantModal, bind$0040_23.SharePack))]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
            }
            else {
                return [model, Cmd_none()];
            }
        case 22:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_62.tag === 1) {
                    ...
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_29.Project, false, t_29.Generating, t_29.VideoGenerating, t_29.Previewing, t_29.Baking, t_29.PreviewUrl, t_29.BakeUrl, t_29.PreviewJobId, t_29.BakeJobId, msg.fields[0].fields[0], t_29.DragIndex, t_29.SelectedBlockId, t_29.VoiceoverDraft, t_29.ImagePromptDraft, t_29.MoodTagsDraft, t_29.CrossfadeDurationDraft, t_29.DirectorNotesDraft, t_29.ShotKindDraft, t_29.BakeDurationDraft, t_29.ImagePromptQuickButtons, t_29.ReferenceStrengthDraft, t_29.MediaRevision, t_29.VariantModal, t_29.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 23:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_64.tag === 1) {
                    ...
                    matchValue_65 = [tryParse_1(msg.fields[0].fields[0], new FSharpRef(() => outArg, (v) => {
                        outArg = v;
                    })), outArg];
                    if (matchValue_65[0]) {
        ...
        case 8:
            if (msg.fields[0].tag === 1) {
                ...
                if (lastBlock == null) {
                    ...
                    timeline_1 = (new TimelineModel(t_37.Project, t_37.Saving, t_37.Generating, t_37.VideoGenerating, t_37.Previewing, t_37.Baking, t_37.PreviewUrl, t_37.BakeUrl, t_37.PreviewJobId, t_37.BakeJobId, t_37.Error, t_37.DragIndex, t_37.SelectedBlockId, t_37.VoiceoverDraft, "", t_37.MoodTagsDraft, t_37.CrossfadeDurationDraft, t_37.DirectorNotesDraft, t_37.ShotKindDraft, t_37.BakeDurationDraft, t_37.ImagePromptQuickButtons, t_37.ReferenceStrengthDraft, t_37.MediaRevision, t_37.VariantModal, t_37.SharePack));
                }
                const model$0027_16 = new AppModel(model.Shell, new AppPage(1, [new TimelineModel(timeline_1.Project, false, timeline_1.Generating, timeline_1.VideoGenerating, timeline_1.Previewing, timeline_1.Baking, timeline_1.PreviewUrl, timeline_1.BakeUrl, timeline_1.PreviewJobId, timeline_1.BakeJobId, undefined, timeline_1.DragIndex, timeline_1.SelectedBlockId, timeline_1.VoiceoverDraft, timeline_1.ImagePromptDraft, timeline_1.MoodTagsDraft, timeline_1.CrossfadeDurationDraft, timeline_1.DirectorNotesDraft, timeline_1.ShotKindDraft, timeline_1.BakeDurationDraft, timeline_1.ImagePromptQuickButtons, timeline_1.ReferenceStrengthDraft, timeline_1.MediaRevision, timeline_1.VariantModal, timeline_1.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport);
                if (lastBlock == null) {
                    ...
                    }, () => useBlockThumbnailAsReference(msg.fields[0].fields[0].Id, block_1.Id), undefined, (Item_36) => (new AppMsg(31, [Item_36])))];
                }
            }
            else {
                return [model, Cmd_none()];
        ...
        case 9:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_91.tag === 1) {
                    const t_56 = matchValue_91.fields[0];
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_56.Project, false, t_56.Generating, t_56.VideoGenerating, t_56.Previewing, t_56.Baking, t_56.PreviewUrl, t_56.BakeUrl, t_56.PreviewJobId, t_56.BakeJobId, msg.fields[0].fields[0], t_56.DragIndex, t_56.SelectedBlockId, t_56.VoiceoverDraft, t_56.ImagePromptDraft, t_56.MoodTagsDraft, t_56.CrossfadeDurationDraft, t_56.DirectorNotesDraft, t_56.ShotKindDraft, t_56.BakeDurationDraft, t_56.ImagePromptQuickButtons, t_56.ReferenceStrengthDraft, t_56.MediaRevision, t_56.VariantModal, t_56.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_90.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withProject(msg.fields[0].fields[0], matchValue_90.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 31:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_104.tag === 1) {
                    const t_64 = matchValue_104.fields[0];
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_64.Project, false, t_64.Generating, t_64.VideoGenerating, t_64.Previewing, t_64.Baking, t_64.PreviewUrl, t_64.BakeUrl, t_64.PreviewJobId, t_64.BakeJobId, msg.fields[0].fields[0], t_64.DragIndex, t_64.SelectedBlockId, t_64.VoiceoverDraft, t_64.ImagePromptDraft, t_64.MoodTagsDraft, t_64.CrossfadeDurationDraft, t_64.DirectorNotesDraft, t_64.ShotKindDraft, t_64.BakeDurationDraft, t_64.ImagePromptQuickButtons, t_64.ReferenceStrengthDraft, t_64.MediaRevision, t_64.VariantModal, t_64.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_103.tag === 1) {
                    const t$0027_1 = StoryboardTimeline_withProject(msg.fields[0].fields[0], matchValue_103.fields[0]);
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t$0027_1.Project, t$0027_1.Saving, t$0027_1.Generating, t$0027_1.VideoGenerating, t$0027_1.Previewing, t$0027_1.Baking, t$0027_1.PreviewUrl, t$0027_1.BakeUrl, t$0027_1.PreviewJobId, t$0027_1.BakeJobId, t$0027_1.Error, t$0027_1.DragIndex, t$0027_1.SelectedBlockId, t$0027_1.VoiceoverDraft, StoryboardTimeline_isUnusablePromptDraft(t$0027_1.ImagePromptDraft) ? "" : t$0027_1.ImagePromptDraft, t$0027_1.MoodTagsDraft, t$0027_1.CrossfadeDurationDraft, t$0027_1.DirectorNotesDraft, t$0027_1.ShotKindDraft, t$0027_1.BakeDurationDraft, t$0027_1.ImagePromptQuickButtons, t$0027_1.ReferenceStrengthDraft, t$0027_1.MediaRevision, t$0027_1.VariantModal, t$0027_1.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 10:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_106.tag === 1) {
                    const t_66 = matchValue_106.fields[0];
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_66.Project, t_66.Saving, false, t_66.VideoGenerating, t_66.Previewing, t_66.Baking, t_66.PreviewUrl, t_66.BakeUrl, t_66.PreviewJobId, t_66.BakeJobId, msg.fields[0].fields[0], t_66.DragIndex, t_66.SelectedBlockId, t_66.VoiceoverDraft, t_66.ImagePromptDraft, t_66.MoodTagsDraft, t_66.CrossfadeDurationDraft, t_66.DirectorNotesDraft, t_66.ShotKindDraft, t_66.BakeDurationDraft, t_66.ImagePromptQuickButtons, t_66.ReferenceStrengthDraft, t_66.MediaRevision, t_66.VariantModal, t_66.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_105.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withProjectAfterGenerate(msg.fields[0].fields[0], matchValue_105.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 11:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_108.tag === 1) {
                    const t_68 = matchValue_108.fields[0];
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_68.Project, t_68.Saving, t_68.Generating, false, t_68.Previewing, t_68.Baking, t_68.PreviewUrl, t_68.BakeUrl, t_68.PreviewJobId, t_68.BakeJobId, msg.fields[0].fields[0], t_68.DragIndex, t_68.SelectedBlockId, t_68.VoiceoverDraft, t_68.ImagePromptDraft, t_68.MoodTagsDraft, t_68.CrossfadeDurationDraft, t_68.DirectorNotesDraft, t_68.ShotKindDraft, t_68.BakeDurationDraft, t_68.ImagePromptQuickButtons, t_68.ReferenceStrengthDraft, t_68.MediaRevision, t_68.VariantModal, t_68.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_107.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withProjectAfterGenerate(msg.fields[0].fields[0], matchValue_107.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 12:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_112.tag === 1) {
                    const t_71 = matchValue_112.fields[0];
                    return [new AppModel(model.Shell, new AppPage(1, [new TimelineModel(t_71.Project, false, t_71.Generating, t_71.VideoGenerating, t_71.Previewing, t_71.Baking, t_71.PreviewUrl, t_71.BakeUrl, t_71.PreviewJobId, t_71.BakeJobId, msg.fields[0].fields[0], t_71.DragIndex, t_71.SelectedBlockId, t_71.VoiceoverDraft, t_71.ImagePromptDraft, t_71.MoodTagsDraft, t_71.CrossfadeDurationDraft, t_71.DirectorNotesDraft, t_71.ShotKindDraft, t_71.BakeDurationDraft, t_71.ImagePromptQuickButtons, t_71.ReferenceStrengthDraft, t_71.MediaRevision, t_71.VariantModal, t_71.SharePack)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_111.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withProject(msg.fields[0].fields[0], matchValue_111.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 13:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_115.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withPreviewError(msg.fields[0].fields[0], matchValue_115.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
                ...
                if (matchValue_114.tag === 1) {
                    return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withPreviewStarted(msg.fields[0].fields[0].JobId, matchValue_114.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                }
                else {
                    return [model, Cmd_none()];
                }
        ...
        case 14: {
            ...
            if (matchValue_116.tag === 1) {
                return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_withPreviewUrl(msg.fields[0], matchValue_116.fields[0])]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
            }
            else {
                return [model, Cmd_none()];
            }
        ...
        case 17:
            if (msg.fields[0].tag === 1) {
                ...
                if (matchValue_118.tag === 2) {
                    const st_2 = matchValue_118.fields[0];
            ...
            switch (msg.fields[0].tag) {
                case 15: {
                    ...
                    if (matchValue_119.tag === 2) {
                        const st_3 = matchValue_119.fields[0];
                ...
                case 16: {
                    ...
                    if (matchValue_120.tag === 2) {
                        const st_4 = matchValue_120.fields[0];
                ...
                case 17: {
                    const matchValue_121 = model.Page;
                    if (matchValue_121.tag === 2) {
                        const st_5 = matchValue_121.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_5.Status, st_5.ModelStatus, st_5.Message, st_5.CheckingUpdates, st_5.SyncingModels, st_5.ShowFirstRunBanner, st_5.ErrorReportingConsent, st_5.ErrorReportingBusy, st_5.ConnectedAccounts, st_5.OAuthBusy, addCustom(st_5.QuickButtonLabelDraft, st_5.QuickButtonPromptDraft), "", "")]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), singleton((dispatch_5) => {
                            dispatch_5(new AppMsg(2, [new TimelineMsg(24, [])]));
                        })];
                    }
                    else {
                        return [model, Cmd_none()];
                ...
                case 18: {
                    ...
                    if (matchValue_122.tag === 2) {
                        const st_6 = matchValue_122.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_6.Status, st_6.ModelStatus, st_6.Message, st_6.CheckingUpdates, st_6.SyncingModels, st_6.ShowFirstRunBanner, st_6.ErrorReportingConsent, st_6.ErrorReportingBusy, st_6.ConnectedAccounts, st_6.OAuthBusy, removeCustom(msg.fields[0].fields[0]), st_6.QuickButtonLabelDraft, st_6.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), singleton((dispatch_6) => {
                            dispatch_6(new AppMsg(2, [new TimelineMsg(24, [])]));
                        })];
                    }
                    else {
                        return [model, Cmd_none()];
                ...
                case 0: {
                    ...
                    if (matchValue_123.tag === 2) {
                        const st_7 = matchValue_123.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_7.Status, st_7.ModelStatus, st_7.Message, true, st_7.SyncingModels, st_7.ShowFirstRunBanner, st_7.ErrorReportingConsent, st_7.ErrorReportingBusy, st_7.ConnectedAccounts, st_7.OAuthBusy, st_7.QuickButtonsCustom, st_7.QuickButtonLabelDraft, st_7.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_52) => {
                            AsyncHelpers_start(x_52);
                        }, checkForUpdates, undefined, (r_2) => (new AppMsg(19, [(r_2.tag === 1) ? r_2.fields[0] : r_2.fields[0]])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 5: {
                    const matchValue_126 = model.Page;
                    if (matchValue_126.tag === 2) {
                        const st_10 = matchValue_126.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_10.Status, st_10.ModelStatus, st_10.Message, st_10.CheckingUpdates, true, st_10.ShowFirstRunBanner, st_10.ErrorReportingConsent, st_10.ErrorReportingBusy, st_10.ConnectedAccounts, st_10.OAuthBusy, st_10.QuickButtonsCustom, st_10.QuickButtonLabelDraft, st_10.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_batch(ofArray([Cmd_OfAsyncWith_perform((x_54) => {
                            AsyncHelpers_start(x_54);
                        }, () => syncModels(false), undefined, (r_3) => (new AppMsg(19, [(r_3.tag === 1) ? r_3.fields[0] : "Model check started"]))), Cmd_OfAsyncWith_perform((x_55) => {
                            AsyncHelpers_start(x_55);
                        }, getModelStatus, undefined, (Item_47) => (new AppMsg(18, [Item_47])))]))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 6: {
                    ...
                    if (matchValue_127.tag === 2) {
                        const st_11 = matchValue_127.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_11.Status, st_11.ModelStatus, st_11.Message, st_11.CheckingUpdates, true, st_11.ShowFirstRunBanner, st_11.ErrorReportingConsent, st_11.ErrorReportingBusy, st_11.ConnectedAccounts, st_11.OAuthBusy, st_11.QuickButtonsCustom, st_11.QuickButtonLabelDraft, st_11.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_batch(ofArray([Cmd_OfAsyncWith_perform((x_56) => {
                            AsyncHelpers_start(x_56);
                        }, () => syncModels(true), undefined, (r_4) => (new AppMsg(19, [(r_4.tag === 1) ? r_4.fields[0] : "Model sync/pull started"]))), Cmd_OfAsyncWith_perform((x_57) => {
                            AsyncHelpers_start(x_57);
                        }, getModelStatus, undefined, (Item_48) => (new AppMsg(18, [Item_48])))]))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 7: {
                    ...
                    if (matchValue_128.tag === 2) {
                        const st_12 = matchValue_128.fields[0];
                ...
                case 1: {
                    const matchValue_129 = model.Page;
                    if (matchValue_129.tag === 2) {
                        const st_13 = matchValue_129.fields[0];
                        Settings_markBootstrapStarted();
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_13.Status, st_13.ModelStatus, st_13.Message, st_13.CheckingUpdates, st_13.SyncingModels, false, st_13.ErrorReportingConsent, st_13.ErrorReportingBusy, st_13.ConnectedAccounts, st_13.OAuthBusy, st_13.QuickButtonsCustom, st_13.QuickButtonLabelDraft, st_13.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_batch(ofArray([Cmd_OfAsyncWith_perform((x_58) => {
                            AsyncHelpers_start(x_58);
                        }, runBootstrap, undefined, () => (new AppMsg(19, ["Bootstrap started"]))), Cmd_OfAsyncWith_perform((x_59) => {
                            AsyncHelpers_start(x_59);
                        }, getSystemStatus, undefined, (Item_49) => (new AppMsg(17, [Item_49])))]))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 3:
                    if (model.Page.tag === 2) {
                        return [model, Cmd_OfAsyncWith_perform((x_60) => {
                            AsyncHelpers_start(x_60);
                        }, runRepair, undefined, () => (new AppMsg(19, ["Repair started"])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                case 9: {
                    ...
                    if (matchValue_131.tag === 2) {
                        const st_14 = matchValue_131.fields[0];
                ...
                case 10: {
                    ...
                    if (matchValue_132.tag === 2) {
                        const st_15 = matchValue_132.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_15.Status, st_15.ModelStatus, st_15.Message, st_15.CheckingUpdates, st_15.SyncingModels, st_15.ShowFirstRunBanner, st_15.ErrorReportingConsent, true, st_15.ConnectedAccounts, st_15.OAuthBusy, st_15.QuickButtonsCustom, st_15.QuickButtonLabelDraft, st_15.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_61) => {
                            AsyncHelpers_start(x_61);
                        }, flushErrorReports, undefined, (r_5) => (new AppMsg(19, [(r_5.tag === 1) ? r_5.fields[0] : (`Queued reports flushed: ${r_5.fields[0]}`)])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 11: {
                    const matchValue_133 = model.PendingErrorReport;
                    if (matchValue_133 != null) {
                        const json_1 = matchValue_133;
                        const matchValue_134 = model.Page;
                        if (matchValue_134.tag === 2) {
                            const st_16 = matchValue_134.fields[0];
                            return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_16.Status, st_16.ModelStatus, st_16.Message, st_16.CheckingUpdates, st_16.SyncingModels, st_16.ShowFirstRunBanner, st_16.ErrorReportingConsent, true, st_16.ConnectedAccounts, st_16.OAuthBusy, st_16.QuickButtonsCustom, st_16.QuickButtonLabelDraft, st_16.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_62) => {
                            ...
                            })), json_1, (Item_50) => (new AppMsg(38, [Item_50])))];
                        }
                        else {
                            ...
                            })), json_1, (Item_51) => (new AppMsg(38, [Item_51])))];
                        }
                    }
                    else {
                        return [model, singleton((dispatch_7) => {
                            dispatch_7(new AppMsg(19, ["No captured error report yet — reproduce an error or wait for one to occur."]));
                        })];
                    }
                }
                case 2:
                    if (model.Page.tag === 2) {
                        return [model, Cmd_OfAsyncWith_perform((x_64) => {
                            AsyncHelpers_start(x_64);
                        }, runConflictScan, undefined, () => (new AppMsg(19, ["Conflict scan complete"])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                case 12: {
                    const matchValue_136 = model.Page;
                    if (matchValue_136.tag === 2) {
                        const st_17 = matchValue_136.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_17.Status, st_17.ModelStatus, st_17.Message, st_17.CheckingUpdates, st_17.SyncingModels, st_17.ShowFirstRunBanner, st_17.ErrorReportingConsent, st_17.ErrorReportingBusy, st_17.ConnectedAccounts, undefined, st_17.QuickButtonsCustom, st_17.QuickButtonLabelDraft, st_17.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_65) => {
                            AsyncHelpers_start(x_65);
                        }, getConnectedAccounts, undefined, (Item_52) => (new AppMsg(27, [Item_52])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                case 13: {
                    const matchValue_140 = model.Page;
                    if (matchValue_140.tag === 2) {
                        const st_20 = matchValue_140.fields[0];
                        return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_20.Status, st_20.ModelStatus, st_20.Message, st_20.CheckingUpdates, st_20.SyncingModels, st_20.ShowFirstRunBanner, st_20.ErrorReportingConsent, st_20.ErrorReportingBusy, st_20.ConnectedAccounts, msg.fields[0].fields[0], st_20.QuickButtonsCustom, st_20.QuickButtonLabelDraft, st_20.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_66) => {
                            AsyncHelpers_start(x_66);
                        }, () => startOAuth(msg.fields[0].fields[0]), undefined, (Item_53) => (new AppMsg(28, [Item_53])))];
                    }
                    else {
                        return [model, Cmd_none()];
                    }
                ...
                default: {
                    ...
                    return [patternInput_12[0], Cmd_batch(ofArray([patternInput_12[1], Cmd_OfAsyncWith_perform((x_51) => {
                        AsyncHelpers_start(x_51);
                    }, getProjects, undefined, (Item_45) => (new AppMsg(4, [Item_45])))]))];
                }
            }
        case 18:
            if (msg.fields[0].tag === 1) {
                ...
                const matchValue_124 = model.Page;
                if (matchValue_124.tag === 2) {
                    const st_8 = matchValue_124.fields[0];
        ...
        case 27:
            if (msg.fields[0].tag === 1) {
                const matchValue_139 = model.Page;
                if (matchValue_139.tag === 2) {
                    const st_19 = matchValue_139.fields[0];
                ...
                const matchValue_137 = model.Page;
                switch (matchValue_137.tag) {
                    case 2: {
                        const st_18 = matchValue_137.fields[0];
                    ...
                    case 1: {
                        const t_77 = matchValue_137.fields[0];
                        if (t_77.SharePack == null) {
                            return [model, Cmd_none()];
                        }
                        else {
                            return [new AppModel(model.Shell, new AppPage(1, [StoryboardTimeline_updateSharePack((sp_9) => (new SharePackModel(sp_9.OutputDir, sp_9.Files, sp_9.CaptionPath, sp_9.CaptionText, sp_9.ReadmePath, sp_9.MediaBase, sp_9.Uploading, sp_9.UploadMessage, msg.fields[0].fields[0])), t_77)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                        }
                    }
                    default:
                        return [model, Cmd_none()];
        ...
        case 28:
            if (msg.fields[0].tag === 1) {
                const matchValue_142 = model.Page;
                if (matchValue_142.tag === 2) {
                    const st_22 = matchValue_142.fields[0];
                ...
                const matchValue_141 = model.Page;
                if (matchValue_141.tag === 2) {
                    const st_21 = matchValue_141.fields[0];
        ...
        case 29: {
            const matchValue_144 = model.Page;
            if (matchValue_144.tag === 2) {
                const st_24 = matchValue_144.fields[0];
                return [new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_24.Status, st_24.ModelStatus, msg.fields[0], st_24.CheckingUpdates, st_24.SyncingModels, st_24.ShowFirstRunBanner, st_24.ErrorReportingConsent, st_24.ErrorReportingBusy, st_24.ConnectedAccounts, undefined, st_24.QuickButtonsCustom, st_24.QuickButtonLabelDraft, st_24.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_OfAsyncWith_perform((x_68) => {
                    AsyncHelpers_start(x_68);
                }, getConnectedAccounts, undefined, (Item_54) => (new AppMsg(27, [Item_54])))];
            }
            else {
                return [model, Cmd_none()];
            }
        ...
        case 19:
            return [(matchValue_145 = model.Page, (matchValue_145.tag === 2) ? ((st_25 = matchValue_145.fields[0], new AppModel(model.Shell, new AppPage(2, [new SettingsModel(st_25.Status, st_25.ModelStatus, msg.fields[0], false, st_25.SyncingModels, st_25.ShowFirstRunBanner, st_25.ErrorReportingConsent, false, st_25.ConnectedAccounts, st_25.OAuthBusy, st_25.QuickButtonsCustom, st_25.QuickButtonLabelDraft, st_25.QuickButtonPromptDraft)]), model.SetupWizard, model.OpenProjectId, model.HostStartup, model.PendingErrorReport))) : model), Cmd_none()];
        case 33:
            switch (msg.fields[0].tag) {
                case 1: {
                    const matchValue_147 = model.SetupWizard;
                    if (matchValue_147 == null) {
                        return [model, Cmd_none()];
                    }
                    else {
                        return [new AppModel(model.Shell, model.Page, SetupWizard_back(matchValue_147), model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                }
                case 2: {
                    const matchValue_148 = model.SetupWizard;
                    if (matchValue_148 == null) {
                        return [model, Cmd_none()];
                    }
                    else {
                        const w_2 = matchValue_148;
                        return [new AppModel((bind$0040_26 = model.Shell, new ShellModel(new ShellTab(2, []), bind$0040_26.Activity, bind$0040_26.SystemStatus)), new AppPage(2, [Settings_init()]), new SetupWizardModel(w_2.Step, "Open Settings — bootstrap started from wizard."), model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_batch(ofArray([Cmd_OfAsyncWith_perform((x_69) => {
                            AsyncHelpers_start(x_69);
                        }, runBootstrap, undefined, () => (new AppMsg(19, ["Bootstrap started"]))), Cmd_OfAsyncWith_perform((x_70) => {
                            AsyncHelpers_start(x_70);
                        }, getSystemStatus, undefined, (Item_55) => (new AppMsg(17, [Item_55])))]))];
                    }
                }
                case 3: {
                ...
                default: {
                    const matchValue_146 = model.SetupWizard;
                    if (matchValue_146 == null) {
                        return [model, Cmd_none()];
                    }
                    else {
                        return [new AppModel(model.Shell, model.Page, SetupWizard_next(matchValue_146), model.OpenProjectId, model.HostStartup, model.PendingErrorReport), Cmd_none()];
                    }
                }
            }
        default:

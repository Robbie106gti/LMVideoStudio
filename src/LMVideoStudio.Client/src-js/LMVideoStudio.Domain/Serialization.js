...
import { SequencePresetModule_toSchemaValue, Project, StylePack, RenderDefaults, ProjectModule_defaultMockupDurationSec, SequencePresetModule_fromSchemaValue, StoryboardBlock, BlockArtifacts, BlockGeneration, BlockAudio, RenderProfile, RenderTier, TransitionSpec, TransitionEdge, MockupAudioQuality, AudioSource, BlockShotKindModule_toSchemaValue, BlockShotKindModule_fromSchemaValue, BlockSource, UpscaleTier, KenBurnsMode, TransitionType } from "./Types.js";
import { filter, map as map_1, toArray as toArray_1, defaultArg, defaultArgWith } from "../fable_modules/fable-library-js.4.27.0/Option.js";
import { singleton, append as append_1, isEmpty, empty, ofArray, map, toArray } from "../fable_modules/fable-library-js.4.27.0/List.js";
import { singleton as singleton_1, append, delay, toList } from "../fable_modules/fable-library-js.4.27.0/Seq.js";
...
function shotKindCodec(s) {
    return defaultArgWith(BlockShotKindModule_fromSchemaValue(s), () => {
        throw new Error(`Unknown shot kind: ${s}`);
    });
}

const shotKindToString = BlockShotKindModule_toSchemaValue;
...
export const blockDecoder = (path_28) => ((v_3) => Thoth_Json_Net_Decode_object((get$) => {
    let objectArg, objectArg_1, objectArg_2, objectArg_3, objectArg_4, objectArg_5, objectArg_6, objectArg_7, objectArg_8, objectArg_9, objectArg_10, objectArg_11, objectArg_12, objectArg_13, objectArg_17, objectArg_21;
    return new StoryboardBlock((objectArg = get$.Required, objectArg.Field("id", Thoth_Json_Net_Decode_guid)), (objectArg_1 = get$.Required, objectArg_1.Field("order", uncurry2(Thoth_Json_Net_Decode_int))), (objectArg_2 = get$.Optional, objectArg_2.Field("title", Thoth_Json_Net_Decode_string)), (objectArg_3 = get$.Required, objectArg_3.Field("source", (path_3, value_1) => Thoth_Json_Net_Decode_map(blockSourceCodec, Thoth_Json_Net_Decode_string, path_3, value_1))), (objectArg_4 = get$.Optional, objectArg_4.Field("thumbnailPath", Thoth_Json_Net_Decode_string)), (objectArg_5 = get$.Optional, objectArg_5.Field("imagePrompt", Thoth_Json_Net_Decode_string)), (objectArg_6 = get$.Optional, objectArg_6.Field("voiceoverScript", Thoth_Json_Net_Decode_string)), (objectArg_7 = get$.Optional, objectArg_7.Field("directorNotes", Thoth_Json_Net_Decode_string)), defaultArg((objectArg_8 = get$.Optional, objectArg_8.Field("moodTags", (path_9, value_2) => Thoth_Json_Net_Decode_list(Thoth_Json_Net_Decode_string, path_9, value_2))), empty()), (objectArg_9 = get$.Optional, objectArg_9.Field("shotKind", (path_11, value_4) => Thoth_Json_Net_Decode_map(shotKindCodec, Thoth_Json_Net_Decode_string, path_11, value_4))), (objectArg_10 = get$.Optional, objectArg_10.Field("mockupDurationSec", Thoth_Json_Net_Decode_float)), (objectArg_11 = get$.Optional, objectArg_11.Field("bakeDurationSec", Thoth_Json_Net_Decode_float)), (objectArg_12 = get$.Optional, objectArg_12.Field("transitions", uncurry2(transitionSpecDecoder))), (objectArg_13 = get$.Optional, objectArg_13.Field("audio", (path_19, v) => Thoth_Json_Net_Decode_object((g) => {
        let objectArg_14, objectArg_15, objectArg_16;
        return new BlockAudio((objectArg_14 = g.Optional, objectArg_14.Field("path", Thoth_Json_Net_Decode_string)), defaultArg((objectArg_15 = g.Optional, objectArg_15.Field("source", (path_16, value_5) => Thoth_Json_Net_Decode_map(audioSourceCodec, Thoth_Json_Net_Decode_string, path_16, value_5))), new AudioSource(0, [])), defaultArg((objectArg_16 = g.Optional, objectArg_16.Field("mockupQuality", (path_18, value_7) => Thoth_Json_Net_Decode_map(mockupQualityCodec, Thoth_Json_Net_Decode_string, path_18, value_7))), new MockupAudioQuality(0, [])));
    }, path_19, v))), (objectArg_17 = get$.Optional, objectArg_17.Field("generation", (path_23, v_1) => Thoth_Json_Net_Decode_object((g_1) => {
        let objectArg_18, objectArg_19, objectArg_20;
        return new BlockGeneration((objectArg_18 = g_1.Optional, objectArg_18.Field("seed", uncurry2(Thoth_Json_Net_Decode_int))), (objectArg_19 = g_1.Optional, objectArg_19.Field("referenceAssetPath", Thoth_Json_Net_Decode_string)), filter((arg_42) => !isEmpty(arg_42), (objectArg_20 = g_1.Optional, objectArg_20.Field("thumbnailVariants", (path_22, value_9) => Thoth_Json_Net_Decode_list(Thoth_Json_Net_Decode_string, path_22, value_9)))));
    }, path_23, v_1))), (objectArg_21 = get$.Optional, objectArg_21.Field("artifacts", (path_27, v_2) => Thoth_Json_Net_Decode_object((g_2) => {
        let objectArg_22, objectArg_23, objectArg_24;
        return new BlockArtifacts((objectArg_22 = g_2.Optional, objectArg_22.Field("mockupVideoPath", Thoth_Json_Net_Decode_string)), (objectArg_23 = g_2.Optional, objectArg_23.Field("bakeVideoPath", Thoth_Json_Net_Decode_string)), (objectArg_24 = g_2.Optional, objectArg_24.Field("upscaledImagePath", Thoth_Json_Net_Decode_string)));
    }, path_27, v_2))));
}, path_28, v_3));

export function blockEncoder(block) {
    const optional = (name, value) => ofArray(toArray_1(map_1((v) => [name, v], value)));
    return Thoth_Json_Net_Encode_object(append_1(ofArray([["id", Thoth_Json_Net_Encode_guid(block.Id)], ["order", Thoth_Json_Net_Encode_int(block.Order)], ["source", Thoth_Json_Net_Encode_string(blockSourceToString(block.Source))]]), append_1(optional("title", map_1(Thoth_Json_Net_Encode_string, block.Title)), append_1(optional("thumbnailPath", map_1(Thoth_Json_Net_Encode_string, block.ThumbnailPath)), append_1(optional("imagePrompt", map_1(Thoth_Json_Net_Encode_string, block.ImagePrompt)), append_1(optional("voiceoverScript", map_1(Thoth_Json_Net_Encode_string, block.VoiceoverScript)), append_1(optional("directorNotes", map_1(Thoth_Json_Net_Encode_string, block.DirectorNotes)), append_1(isEmpty(block.MoodTags) ? empty() : singleton(["moodTags", encodeStringList(block.MoodTags)]), append_1(optional("shotKind", map_1((k) => Thoth_Json_Net_Encode_string(shotKindToString(k)), block.ShotKind)), append_1(optional("mockupDurationSec", map_1(Thoth_Json_Net_Encode_float, block.MockupDurationSec)), append_1(optional("bakeDurationSec", map_1(Thoth_Json_Net_Encode_float, block.BakeDurationSec)), append_1(optional("transitions", map_1(transitionSpecEncoder, block.Transitions)), append_1(optional("audio", map_1((a) => Thoth_Json_Net_Encode_object(toList(delay(() => append(optional("path", map_1(Thoth_Json_Net_Encode_string, a.Path)), delay(() => append(singleton_1(["source", Thoth_Json_Net_Encode_string(audioSourceToString(a.Source))]), delay(() => singleton_1(["mockupQuality", Thoth_Json_Net_Encode_string(mockupQualityToString(a.MockupQuality))])))))))), block.Audio)), append_1(optional("generation", map_1((g) => Thoth_Json_Net_Encode_object(toList(delay(() => append(optional("seed", map_1(Thoth_Json_Net_Encode_int, g.Seed)), delay(() => append(optional("referenceAssetPath", map_1(Thoth_Json_Net_Encode_string, g.ReferenceAssetPath)), delay(() => defaultArg(map_1((vs) => singleton(["thumbnailVariants", Thoth_Json_Net_Encode_array(toArray(map(Thoth_Json_Net_Encode_string, vs)))]), filter((arg) => !isEmpty(arg), g.ThumbnailVariants)), empty())))))))), block.Generation)), optional("artifacts", map_1((a_1) => Thoth_Json_Net_Encode_object(toList(delay(() => append(optional("mockupVideoPath", map_1(Thoth_Json_Net_Encode_string, a_1.MockupVideoPath)), delay(() => append(optional("bakeVideoPath", map_1(Thoth_Json_Net_Encode_string, a_1.BakeVideoPath)), delay(() => optional("upscaledImagePath", map_1(Thoth_Json_Net_Encode_string, a_1.UpscaledImagePath))))))))), block.Artifacts))))))))))))))));
}
...
export function encodeBlock(block) {
    return Thoth_Json_Net_Encode_toString(0, blockEncoder(block));
}

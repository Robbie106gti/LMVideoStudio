...
import { SequencePresetModule_toSchemaValue, Project, StylePack, RenderDefaults, ProjectModule_defaultMockupDurationSec, SequencePresetModule_fromSchemaValue, StoryboardBlock, BlockArtifacts, BlockGeneration, BlockAudio, RenderProfile, RenderTier, TransitionSpec, TransitionEdge, MockupAudioQuality, AudioSource, BlockSource, UpscaleTier, KenBurnsMode, TransitionType } from "./Types.js";
import { singleton, append as append_1, isEmpty, empty, ofArray, map, toArray } from "../fable_modules/fable-library-js.4.27.0/List.js";
import { filter, map as map_1, toArray as toArray_1, defaultArg } from "../fable_modules/fable-library-js.4.27.0/Option.js";
...
export const blockDecoder = (path_26) => ((v_3) => Thoth_Json_Net_Decode_object((get$) => {
    let objectArg, objectArg_1, objectArg_2, objectArg_3, objectArg_4, objectArg_5, objectArg_6, objectArg_7, objectArg_8, objectArg_9, objectArg_10, objectArg_11, objectArg_12, objectArg_16, objectArg_20;
    ...
    }, path_17, v))), (objectArg_16 = get$.Optional, objectArg_16.Field("generation", (path_21, v_1) => Thoth_Json_Net_Decode_object((g_1) => {
        let objectArg_17, objectArg_18, objectArg_19;
        return new BlockGeneration((objectArg_17 = g_1.Optional, objectArg_17.Field("seed", uncurry2(Thoth_Json_Net_Decode_int))), (objectArg_18 = g_1.Optional, objectArg_18.Field("referenceAssetPath", Thoth_Json_Net_Decode_string)), filter((arg_40) => !isEmpty(arg_40), (objectArg_19 = g_1.Optional, objectArg_19.Field("thumbnailVariants", (path_20, value_8) => Thoth_Json_Net_Decode_list(Thoth_Json_Net_Decode_string, path_20, value_8)))));
    }, path_21, v_1))), (objectArg_20 = get$.Optional, objectArg_20.Field("artifacts", (path_25, v_2) => Thoth_Json_Net_Decode_object((g_2) => {
        let objectArg_21, objectArg_22, objectArg_23;
        return new BlockArtifacts((objectArg_21 = g_2.Optional, objectArg_21.Field("mockupVideoPath", Thoth_Json_Net_Decode_string)), (objectArg_22 = g_2.Optional, objectArg_22.Field("bakeVideoPath", Thoth_Json_Net_Decode_string)), (objectArg_23 = g_2.Optional, objectArg_23.Field("upscaledImagePath", Thoth_Json_Net_Decode_string)));
    }, path_25, v_2))));
}, path_26, v_3));

...
import { map as map_2, toArray, singleton as singleton_1, empty } from "./fable_modules/fable-library-js.4.27.0/List.js";
...
const blockDecoder = (path_12) => ((v) => object((get$) => {

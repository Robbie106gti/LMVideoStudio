                                    ...
                                    Html.div [
                                        ...
                                        prop.children [
                                            ...
                                            Html.button [
                                                ...
                                                prop.disabled (model.VideoGenerating || model.Generating)
                                                prop.title "Generates a five-second Wan clip from this block's prompt using the explicitly configured local-media or stable-diffusion.cpp provider."
                                                prop.text (if model.VideoGenerating then "Generating Wan clip…" else "Generate Wan video from prompt")

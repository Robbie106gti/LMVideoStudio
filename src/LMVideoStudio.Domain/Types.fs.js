import { Record, Union } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Types.js";
import { float64_type, list_type, class_type, string_type, option_type, record_type, bool_type, int32_type, union_type } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Reflection.js";
import { utcNow } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/DateOffset.js";
import { newGuid } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Guid.js";
import { choose, mapIndexed, map, empty } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/List.js";
import { tryFind, ofList } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Map.js";
import { comparePrimitives } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Util.js";
import { defaultArg } from "../LMVideoStudio.Client/fable_modules/fable-library-js.4.27.0/Option.js";
...
export class BlockGeneration extends Record {
    constructor(Seed, ReferenceAssetPath) {
        super();
        this.Seed = Seed;
...
export function BlockGeneration_$reflection() {
    return record_type("LMVideoStudio.Domain.BlockGeneration", [], BlockGeneration, () => [["Seed", option_type(int32_type)], ["ReferenceAssetPath", option_type(string_type)]]);
}

export class BlockArtifacts extends Record {
    constructor(MockupVideoPath, BakeVideoPath) {
        super();
...
export function BlockArtifacts_$reflection() {
    return record_type("LMVideoStudio.Domain.BlockArtifacts", [], BlockArtifacts, () => [["MockupVideoPath", option_type(string_type)], ["BakeVideoPath", option_type(string_type)]]);
}
